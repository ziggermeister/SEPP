    ...
    def get_prices(self, symbols: Iterable[str], start: str, end: Optional[str]=None,
        ...
        for sym in symbols:
            ...
            if "adjClose" in df.columns:
                df.rename(columns={"adjClose":"Adj Close","close":"Close","open":"Open","high":"High","low":"Low","volume":"Volume","date":"Date"}, inplace=True)
            elif "close" in df.columns:
                df.rename(columns={"close":"Close","open":"Open","high":"High","low":"Low","volume":"Volume","date":"Date"}, inplace=True)
